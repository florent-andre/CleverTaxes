...
*/
package org.lh.stanbol.enhancer.jersey.fragment;
...
@Service
public class SkosifierWebFragment implements WebFragment {

    private static final String NAME = "skosifier";

    private static final String STATIC_RESOURCE_PATH = "/org/lh/stanbol/enhancer/jersey/static";

    private static final String TEMPLATE_PATH = "/org/lh/stanbol/enhancer/jersey/templates";
...
//    EnhancementJobManager jobManager;
    ...
    public Set<Class<?>> getJaxrsResourceClasses() {
        ...
        // resources
        classes.add(SkosifierRootResource.class);
        return classes;
    }
    ...
    public List<NavigationLink> getNavigationLinks() {
        ...
        links.add(new NavigationLink("skosifier", "/skosifier", "/imports/enginesDescription.ftl", 10));
        return links;
    }
